...
import { ArrowUpRight, CloudRain, CloudSun, MessageCircle, ScanLine, Sparkles, Sprout, Wind, Thermometer, CheckCircle2, ShieldAlert, Droplets, Info } from "lucide-react";
          ...
          <div className="rounded-[32px] border-3 border-[#b77731] bg-[#fff8eb] p-7 sm:p-9 shadow-lg">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b-2 border-[#19352b]/10 pb-5">
              <div className="flex items-center gap-3">
                <span className="flex size-10 items-center justify-center rounded-xl bg-[#b77731] text-[#fff8eb]">
                  <Sparkles size={20} />
                </span>
                <div>
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-2xl border-2 border-[#19352b]/15 bg-white p-5 shadow-sm">
                ...
                <div className="mt-3 rounded-xl bg-[#f5f1e8] p-3 text-xs font-bold leading-relaxed text-[#19352b]">
                  <strong>Voice Support:</strong> Speaks plain-language diagnosis and treatment advice in regional languages.
                </div>
              </div>
