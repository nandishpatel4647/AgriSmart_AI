...
CROP_KNOWLEDGE_BASE = [
    {
        "crop": "Tomato",
        "vernacular_name": "Tomato · ટામેટાં · टमाटर",
        "category": "Vegetables",
        ...
        "plain_fertilizer": "2.5 bags Urea, 1.3 bags DAP, 1 bag Potash per acre",
        "plain_watering": "Irrigate once every 4 to 5 days",
    ...
    {
        "crop": "Corn (Maize)",
        "vernacular_name": "Corn (Maize) · મકાઈ · मक्का",
        "category": "Cereals",
        ...
        "plain_fertilizer": "2.5 bags Urea, 1.3 bags DAP, 0.7 bags Potash per acre",
        "plain_watering": "Irrigate once every 6 to 8 days",
    ...
    {
        "crop": "Potato",
        "vernacular_name": "Potato · બટાકા · आलू",
        "category": "Tubers",
        ...
        "plain_fertilizer": "3 bags Urea, 1.7 bags DAP, 1.6 bags Potash per acre",
        "plain_watering": "Irrigate once every 5 to 7 days",
    ...
    {
        "crop": "Chickpea (Gram)",
        "vernacular_name": "Chickpea (Gram) · ચણા · चना",
        ...
        "plain_fertilizer": "0.5 bags Urea, 0.9 bags DAP (Fixes own soil nitrogen)",
        "plain_watering": "Light irrigation (1 - 2 times full crop cycle)",
        "image_url": "https://images.unsplash.com/photo-1515543904379-3d757abe9962?auto=format&fit=crop&w=600&q=80",
    ...
    {
        "crop": "Cotton",
        "vernacular_name": "Cotton · કપાસ · कपास",
        "category": "Cash Crops",
        ...
        "plain_fertilizer": "2 bags Urea, 1.1 bags DAP, 0.8 bags Potash per acre",
        "plain_watering": "Irrigate once every 8 to 10 days",
        "image_url": "https://images.unsplash.com/photo-1606041008023-472dfb5e530f?auto=format&fit=crop&w=600&q=80",
    ...
    {
        "crop": "Rice (Paddy)",
        "vernacular_name": "Rice (Paddy) · ચોખા / ડાંગર · चावल / धान",
        "category": "Cereals",
        "suitable_seasons": ["Kharif"],
        "ph_range": (5.5, 7.2),
        ...
        "plain_fertilizer": "2 bags Urea, 0.9 bags DAP, 0.7 bags Potash per acre",
        "plain_watering": "Maintain 2-5 cm standing water in field",
...
async def recommend_crop(req: CropRecommendationRequest):
    ...
    for c in CROP_KNOWLEDGE_BASE:
        ...
        scores.append({
            "crop": c["crop"],
            "vernacular_name": c.get("vernacular_name", c["crop"]),
            "category": c["category"],
            "suitability_pct": final_score,
            "rationale": c["rationale"],
            "npk_ratio": c["npk_ratio"],
            "plain_fertilizer": c.get("plain_fertilizer", "Standard NPK balance"),
            "plain_watering": c.get("plain_watering", "Regular irrigation"),
